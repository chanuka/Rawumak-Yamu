...
public class MobMsgInputBean {
    ...
    /*-------for access control-----------*/
    /*------------------------list data table  ------------------------------*/
    private List<MobMsgBean> gridModel;
    ...
    /*------------------------for search ------------------------------*/
    private String paramCodeSearch;
    ...
    public List<MobMsgBean> getGridModel() {
        return gridModel;
    }

    public void setGridModel(List<MobMsgBean> gridModel) {
    ...
    public String getParamCodeSearch() {
        return paramCodeSearch;
    }

    public void setParamCodeSearch(String paramCodeSearch) {
        this.paramCodeSearch = paramCodeSearch;
    }
